...
class Auth extends CI_Controller
{
    ...
    public function registration()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            Crongratulation! your account has been created. Please actived your account
          </div>');
            redirect('auth');
        }
    }
    ...
    private function _sendEmail($token, $type)
    {
        ...
        $config = [
            ...
            'smtp_user' => 'rrnnovv@gmail.com',
            'smtp_pass' => 'venxbywyqyxksfmh',
            'smtp_port' =>  465,
            'mailtype'  => 'html',
            'charset'   => 'utf-8',
            'newline'   => "\r\n"
        ...
        $this->email->from('rrnnovv@gmail.com', 'ririn novita sari');
    ...
    public function changePassword()
    {
        ...
        $this->form_validation->set_rules('password1', 'Password', 'trim|required|min_length[30]|matches[password2]');
        $this->form_validation->set_rules('password2', 'Repet Password', 'trim|required|min_length[30]|matches[password1]');
        if ($this->form_validation->run() == false) {
